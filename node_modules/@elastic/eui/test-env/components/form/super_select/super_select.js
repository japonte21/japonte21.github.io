...
function (_Component) {
  ...
  function EuiSuperSelect() {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (_getPrototypeOf2 = (0, _getPrototypeOf3.default)(EuiSuperSelect)).call.apply(_getPrototypeOf2, [this].concat(args)));
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "itemNodes", []);
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "popoverRef", null);
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onSelectKeyDown", function (e) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onItemKeyDown", function (e) {
      switch (e.keyCode) {
  ...
  (0, _createClass2.default)(EuiSuperSelect, [{
    ...
    value: function render() {
      ...
      var popoverPanelClasses = (0, _classnames.default)('euiSuperSelect__popoverPanel', (0, _defineProperty2.default)({}, "".concat(popoverClassName, "__popoverPanel"), !!popoverClassName));
      ...
      var button = _react.default.createElement(_super_select_control.EuiSuperSelectControl, (0, _extends2.default)({
        options: options,
